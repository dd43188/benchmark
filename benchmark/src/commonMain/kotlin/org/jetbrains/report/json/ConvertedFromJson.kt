...
internal interface ConvertedFromJson {
...
internal fun JsonObject.getRequiredField(fieldName: String): JsonElement {
    return getOrNull(fieldName) ?: error("Field '$fieldName' doesn't exist in '$this'. Please, check origin files.")
}

internal fun JsonObject.getOptionalField(fieldName: String): JsonElement? {
