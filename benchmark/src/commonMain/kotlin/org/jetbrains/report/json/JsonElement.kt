 ...
 */
internal sealed class JsonElement {
 ...
 */
internal data class JsonLiteral internal constructor(
 ...
 */
internal object JsonNull : JsonPrimitive() {
 ...
 */
internal data class JsonObject(val content: Map<String, JsonElement>) : JsonElement(), Map<String, JsonElement> by content {
...
internal data class JsonArray(val content: List<JsonElement>) : JsonElement(), List<JsonElement> by content {
