...
internal data class RecordTimeMeasurement(
...
abstract class BenchmarkArguments(argParser: Any)

class BaseBenchmarkArguments(argParser: Any): BenchmarkArguments(argParser) {
...
internal object BenchmarksRunner {
