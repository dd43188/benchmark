...
internal class ChangeReport<T>(val entityName: String, val changes: List<FieldChange<T>>) {
...
internal class FieldChange<T>(val field: String, val previous: T, val current: T) {
    companion object {
