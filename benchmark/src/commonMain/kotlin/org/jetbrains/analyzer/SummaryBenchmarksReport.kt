...
internal typealias SummaryBenchmark = Pair<MeanVarianceBenchmark?, MeanVarianceBenchmark?>
internal typealias BenchmarksTable = Map<String, MeanVarianceBenchmark>
internal typealias SummaryBenchmarksTable = Map<String, SummaryBenchmark>
internal typealias ScoreChange = Pair<MeanVariance, MeanVariance>

internal class DetailedBenchmarksReport(currentBenchmarks: Map<String, List<BenchmarkResult>>,
...
internal class SummaryBenchmarksReport(val currentReport: BenchmarksReport,
