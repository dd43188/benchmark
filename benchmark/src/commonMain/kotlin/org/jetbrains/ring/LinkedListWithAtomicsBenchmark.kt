...
internal class ChunkBuffer(var readPosition: Int, var writePosition: Int = readPosition + Random.nextInt(50)) {
...
internal class LinkedListOfBuffers(var head: ChunkBuffer = ChunkBuffer(0,0),
...
internal open class LinkedListWithAtomicsBenchmark {
