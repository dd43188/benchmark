...
internal open class ElvisBenchmark {
    ...
    init {
        array = Array(BENCHMARK_SIZE) {
            if (Random.nextInt(BENCHMARK_SIZE) < BENCHMARK_SIZE / 10) null else Value(Random.nextInt(19))
        }
    }
    ...
    fun testCompositeElvis(): Int {
        ...
        for (i in 0..BENCHMARK_SIZE)
            result += check(Composite(Random.nextInt(19), Composite(Random.nextInt(19), null)))
        return result
    }
}
